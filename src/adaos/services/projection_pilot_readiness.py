...
def projection_pilot_readiness_contract_snapshot(*, now: float | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "infrascope_after_prereqs": {
            ...
            "status": "ready_after_prereqs",
            "required_gate_ids": prerequisites,
            "reason": "heavy operator-facing skill validates shared ABI, dispatcher, demand, and diagnostics before wider rollout",
        },
