...
def test_projection_pilot_readiness_contract_snapshot_selects_followup() -> None:
    ...
    assert snapshot["infrascope_after_prereqs"]["status"] == "ready_after_prereqs"
    assert "infrascope_platform_errors_contract" in snapshot["infrascope_after_prereqs"]["required_gate_ids"]
